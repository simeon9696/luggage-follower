...
class About extends StatelessWidget {
  ...
  final List<Dependencies> listOfDependencies= [
    ...
    Dependencies(name: 'syncfusion_flutter_gauges', version: '17.4.40-beta'),
  ];
        ...
        child:Column(
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Text('Ijaz Mohammed - PRJT3001', style: Theme.of(context).textTheme.body1),
              ),
              Padding(
              ...
              Padding(
                ...
                child: Align(
                  ...
                  child: Text(aboutTheApp, style: Theme.of(context).textTheme.display3,textAlign: TextAlign.center,),
                ),
              ),
              Padding(
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Text('Built with ', style: Theme.of(context).textTheme.body1),
                    SizedBox(
                      width: 100.0,
                      height: 90.0,
                    ...
                    Text('v1.13.6-pre.22',style: Theme.of(context).textTheme.body1),
                  ],
                ),
              ),
                          ...
                          child: Column(
                            children: <Widget>[
                              Padding(
                                padding: const EdgeInsets.symmetric(vertical: 0,horizontal: 0),
                                child: ListTile(
                                  title: Text(listOfDependencies[index].name, style: Theme.of(context).textTheme.body1),
                                  trailing: Text(listOfDependencies[index].version),
                                ),
                              ),
                            ],
                          ),
